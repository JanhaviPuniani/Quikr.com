...
//		UserDAO userDao;
		...
		public ModelAndView addCategory(@ModelAttribute("advert") Advert advert, BindingResult result,HttpServletRequest request,UserDAO userDao ) throws Exception {
			...
			try {			
				...
				if (temp) {
					photoInMemory = advert.getPhoto();
					localFile = new File(directory.getPath(), advert.getItemName() + "_".toString() + ".jpg");
					advert.setPhotoFile(localFile.getPath());
					try {
